...
// $Header: r:/t2repos/thief2/libsrc/portold/portal_.h,v 1.9 1997/09/02 19:01:17 buzzard Exp $
...
struct port_render_data
{
   ...
   uchar zero_index;   // if num_unexplored_entries is 0, this is our index in the 0count list
